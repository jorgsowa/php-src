...
class Phar extends RecursiveDirectoryIterator implements Countable, ArrayAccess
{
    ...
    public const int BZ2 = UNKNOWN;
    /** @cvalue PHAR_ENT_COMPRESSED_GZ */
    public const int GZ = UNKNOWN;
    /** @cvalue PHAR_ENT_COMPRESSED_NONE */
    public const int NONE = UNKNOWN;
    /** @cvalue PHAR_FORMAT_PHAR */
    public const int PHAR = UNKNOWN;
    /** @cvalue PHAR_FORMAT_TAR */
    public const int TAR = UNKNOWN;
    /** @cvalue PHAR_FORMAT_ZIP */
    public const int ZIP = UNKNOWN;
    /** @cvalue PHAR_ENT_COMPRESSION_MASK */
    public const int COMPRESSED = UNKNOWN;
    /** @cvalue PHAR_MIME_PHP */
    public const int PHP = UNKNOWN;
    /** @cvalue PHAR_MIME_PHPS */
    public const int PHPS = UNKNOWN;
    /** @cvalue PHAR_SIG_MD5 */
    public const int MD5 = UNKNOWN;
    /** @cvalue PHAR_SIG_OPENSSL */
    public const int OPENSSL = UNKNOWN;
    /** @cvalue PHAR_SIG_OPENSSL_SHA256 */
    public const int OPENSSL_SHA256 = UNKNOWN;
    /** @cvalue PHAR_SIG_OPENSSL_SHA512 */
    public const int OPENSSL_SHA512 = UNKNOWN;
    /** @cvalue PHAR_SIG_SHA1 */
    public const int SHA1 = UNKNOWN;
    /** @cvalue PHAR_SIG_SHA256 */
    public const int SHA256 = UNKNOWN;
    /** @cvalue PHAR_SIG_SHA512 */
    public const int SHA512 = UNKNOWN;
