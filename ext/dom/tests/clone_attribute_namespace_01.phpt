...
?>
--EXPECTF--
Deprecated: Calling setAttributeNs() is deprecated, use the correct casing DOMElement::setAttributeNS() instead in %s on line %d
...
Deprecated: Calling removeAttributeNs() is deprecated, use the correct casing DOMElement::removeAttributeNS() instead in %s on line %d
<?xml version="1.0"?>
